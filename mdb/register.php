                                    ...
                                    <div class="card-body">
                                        <form>
                                             <div class="form-group">
                                                ...
                                                <input class="form-control py-4" id="inputEmailAddress" type="text" placeholder="Enter Username" />
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" id="confirmPassword" type="password" placeholder="Conform password" />
                                            </div>
